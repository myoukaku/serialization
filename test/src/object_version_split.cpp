...
private:
	...
	friend void save(Archive& ar, Object1 const& o, serialization::version_t version)
	{
	...
	template <typename Archive>
	friend void load(Archive& ar, Object1& o, serialization::version_t version)
	{
		EXPECT_EQ(0u, version);
		ar	>> o.a
			>> o.b
...
private:
	template <typename Archive>
	friend void save(Archive& ar, Object2 const& o, serialization::version_t version)
	{
	...
	template <typename Archive>
	friend void load(Archive& ar, Object2& o, serialization::version_t version)
	{
		EXPECT_EQ(1u, version);
		ar	>> o.a
			>> o.b
...
private:
	template <typename Archive>
	friend void save(Archive& ar, Object3 const& o, serialization::version_t version)
	{
	...
	template <typename Archive>
	friend void load(Archive& ar, Object3& o, serialization::version_t version)
	{
		EXPECT_EQ(2u, version);
		ar	>> o.a
			>> o.b
...
void ObjectVersionSplitTest()
{
	ObjectVersionSplitTest2<std::stringstream,  OArchive, IArchive>();
	ObjectVersionSplitTest2<std::wstringstream, OArchive, IArchive>();
}

GTEST_TEST(SerializationTest, ObjectVersionSplitTest)
{
